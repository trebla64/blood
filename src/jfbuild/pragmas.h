...
static inline int32_t divmod(int32_t a, int32_t b) { dmval = a%b; return a/b; }
static inline int32_t moddiv(int32_t a, int32_t b) { dmval = a/b; return a%b; }
...
{ // courtesy of Ken
    ...
    if (p < ((int64)(-2147483648))) p = ((int64)(-2147483648));
    return((int32_t)p);
}
