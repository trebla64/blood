...
void setpalookupaddress(uint8_t *paladdr);
...
void setupmvlineasm(int32 neglogy);
void mvlineasm1(int32 vinc, intptr_t paloffs, int32 cnt, uint32 vplc, intptr_t bufplc, intptr_t p);
